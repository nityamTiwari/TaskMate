package com.ferrytech.todolistexample.utils;
            ...
            if (cr != null){
                if (cr.moveToFirst()){
                    do{
                        ...
                        task.setId(cr.getInt(cr.getColumnIndexOrThrow(ID)));
                        task.setTask(cr.getString(cr.getColumnIndexOrThrow(TASK)));
                        task.setStatus(cr.getInt(cr.getColumnIndexOrThrow(STATUS)));
                        taskList.add(task);
                    }while(cr.moveToNext());
                }
            }
